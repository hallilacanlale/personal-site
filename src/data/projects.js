...
const data = [
  ...
  {
    title: 'Space Potato',
    subtitle: 'A kickstarter fundeddfd potato powered weather balloon.',
  ...
  {
    title: 'Cat Detector',
    subtitle: 'A convolutiossnal neural network to classify cats! (and dogs)',
...
//       + 'bot that executes trades based on a specific trading strategy, with the goal
// of automating profits. '
